...
dp.sh.Toolbar.Create = function(highlighter)
{
    ...
    if(window.clipboardData) {
        div.innerHTML += ' <a href="#" onclick="dp.sh.Toolbar.CopyToClipboard(this);return false;" title="复制代码"><img src="./img/copy.png" alt="复制代码"/></a>';
    }else{
        var code = highlighter.originalCode.replace(/&lt;/g,'<').replace(/&gt;/g,'>').replace(/&amp;/g,'&');
        div.innerHTML += ' <embed wmode="transparent" src="http://www.iteye.com/javascripts/syntaxhighlighter/clipboard_new.swf" width="14" height="15" flashvars="clipboard='+encodeURIComponent(code)+'" quality="high" allowScriptAccess="always" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer"/>';
    }
    return div;
}
